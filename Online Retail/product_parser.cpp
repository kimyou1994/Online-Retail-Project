...
{
    Product *product = new Book("book", prodName_, price_,qty_, isbn_, author_);
    return product;
}
...
{
    Product *product = new Clothing("clothing", prodName_, price_,qty_, size_, brand_);
    return product;
}
...
{
    Product *product = new Movie("movie", prodName_, price_,qty_, genre_, rating_);
    return product;
